...
class Evenement
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Inscrit", inversedBy="evenements")
     */
    private $inscrits;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Question", mappedBy="evenement")
     */
    private $questions;
