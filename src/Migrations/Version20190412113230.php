 ...
 */
final class Version20190412113230 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE organisateur_contact (organisateur_id INT NOT NULL, contact_id INT NOT NULL, INDEX IDX_5F84A3B8D936B2FA (organisateur_id), INDEX IDX_5F84A3B8E7A1254A (contact_id), PRIMARY KEY(organisateur_id, contact_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
